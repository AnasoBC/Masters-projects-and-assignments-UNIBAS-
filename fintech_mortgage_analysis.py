...
# Data files live in the repo's data/ folder (see data/README.md for download instructions).
# Paths are resolved relative to this script so the code runs unchanged on any OS.
from pathlib import Path
DATA_DIR = Path(__file__).resolve().parent.parent / "data"
service = pd.read_csv(DATA_DIR / "servicing2017.csv", low_memory=False)
originator = pd.read_csv(DATA_DIR / "origination2017.csv", low_memory=False)
